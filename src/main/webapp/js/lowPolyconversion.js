...
(function(window, document) {
    ...
    // Configs
	// Detects pixels exceeding this brightness, showing the minimum value when detecting edges from the average brightness, less detail
    var EDGE_DETECT_VALUE = 50;
	//(number)Distribution ratio of points on the edge, the higher the detail, the number of points generated refer to the console
    var POINT_RATE = 0.075;
	// (int) The maximum number of points, the number of points by POINT_RATE does not exceed this value, the larger the details
    ...
    function init() {
        ...
        source = new Image();
        source.crossOrigin = "Anonymous"; // add cross domain support
   ...
   /* function documentClick(e) { 
    ...
    removed conflicting functionality
    */
    ...
    function documentDrop(e) {
        ...
        if (!window.FileReader) {
            alert('Browser not compatible with file operation by drag & drop.');
            return;
        }
	 ...
	 * @ return An array of randomly distributed points on the edge
	 * @ see EDGE_DETECT_VALUE Average value of 3 x 3 lightness to be determined as edge
	 *
     */
    ...
    /*
	 * Debugging log function, log.limit (number) limits the number of outputs
	 * Progress display is normal console.log
	 *
     */
